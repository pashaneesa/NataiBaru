                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-header"><center>Penerimaan Barang</center></h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                                    ...
                                    <form action="<?php echo base_url().'admin/pembelian/add_to_cart'?>" method="post">
                                        <table>
                                            <tr>
                                                ...
                                                <select style="width: 250px" name="suplier" class="form-control" data-live-search="true" title="Pilih Supplier" required>
                                                    <?php foreach ($sup->result_array() as $i) {
                                                        $id_sup=$i['id_supp'];
                                                        $nm_sup=$i['nama_supp'];
                                                        $asal_sup=$i['asal_supp'];
                                                        $al_sup=$i['alamat_supp'];
                                                        $sess_id=$this->session->userdata('suplier');
                                                        if($sess_id==$id_sup)
                                                            echo "<option value='$id_sup' selected>$nm_sup - $asal_sup</option>";
                                                        else
                                                            echo "<option value='$id_sup'>$nm_sup - $asal_sup</option>";
                                                    }?>
                                                </select>
                                                </td>
                                            </tr>
