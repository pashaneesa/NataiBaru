					...
					<table>
						...
						<tr>
		                    ...
		                    <td><input type="text" name="qty_brg" value="<?php echo $b['qty_brg'];?>" style="width:50px;margin-right:5px;" class="form-control input-sm" readonly></td>
		                    <td><input type="text" name="harga_brg" value="<?php echo $b['harga_brg'];?>" style="width:130px;margin-right:5px;" class="form-control input-sm" readonly></td>
		                   <td><input type="number" name="jumlah" id="jumlah" value="1" min="1" max="<?php echo $b['qty_brg'];?>" class="form-control input-sm" style="width:90px;margin-right:5px;" required></td>
