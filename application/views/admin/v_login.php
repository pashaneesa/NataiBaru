...
<html>
  ...
  <body class="login-bg" style="background-color: #F5F5F5">
				...
				<div class="login-wrapper">
			        <div class="box">
			            <div class="content-wrap">
			                <img width="150px" src="<?php echo base_url().'assets/img/logo2.png'?>"/>
	                        ...
	                        <form action="<?php echo base_url().'administrator/cekuser'?>" method="post">
				                ...
				                <div class="action">
				                    <button type="submit" class="btn btn-lg btn-success" style="width:310px;margin-top:0px; bg-color:#ff9000;">Login</button>
				                </div>
	                        </form>
