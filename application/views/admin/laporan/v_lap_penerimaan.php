                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-header"><center>Laporan<small> Penerimaan Barang</small></center></h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="pull-right" style="margin-bottom: 10px;"><a href="<?php echo base_url().'welcome/terima'?>" class="btn btn-sm btn-info"><span class="fa fa-file"></span> Print Laporan</a></div>
                        </div>
                    </div>
                    <!-- /.row -->
                    <div class="row">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            $no=0;
                                                foreach ($data->result_array() as $i) {
                                                    ...
                                                    $nama=$i['nama_supp'];
                                                    $barang_harjul=$i['harga_dterima'];
                                                    $barang_qty=$i['jml_dterima'];
                                                    $barang_total=$i['total_dterima'];
                                            ?>
                                                <tr>
